...
if ( ! class_exists( 'Gamajo_Template_Loader' ) ) {
	...
	class Gamajo_Template_Loader {
		...
		protected function get_template_paths() {
			...
			/* echo '<pre>', var_dump($this->theme_template_directory), '</pre>';
			echo '<br>'; */

			$theme_directory = trailingslashit( $this->theme_template_directory );

			/* echo '<pre>', var_dump($this->get_templates_dir()), '</pre>';
			echo '<br>'; */
		...
		protected function get_templates_dir() {
			$pluginDir = str_replace('\\', '/', $this->plugin_directory);

			return trailingslashit( $pluginDir ) . $this->plugin_template_directory;
		}
	}
}